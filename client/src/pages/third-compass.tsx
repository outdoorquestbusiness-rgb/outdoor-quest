...
export default function ThirdCompass() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `
          radial-gradient(circle at 40% 20%, rgba(34, 197, 94, 0.2) 0%, transparent 50%),
          radial-gradient(circle at 60% 80%, rgba(101, 163, 13, 0.2) 0%, transparent 50%),
          radial-gradient(circle at 20% 60%, rgba(87, 83, 78, 0.15) 0%, transparent 50%)
        `
      }}
    >
      {/* Header with Timer */}
